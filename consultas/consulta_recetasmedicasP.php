...
<!-- Enlaces a los scripts de JavaScript -->
 ...
 <style>
    ...
    * {
    ...
    #tabla_recetas tbody tr:hover {
      background-color: #A8A4DE;
      cursor: pointer;
    }

    #tabla_recetas tbody tr:active {
...
<body>
  ...
  <h2 style="padding:0; text-align: center; text-transform: uppercase;"><i class="fa-solid fa-file-prescription" style="font-size:32px;color:blue;"></i>&nbsp;Consultas Recetas</h2>
      <h3 style="padding:0; margin:0;text-align: center;">PediatraSys</h3>

  <table id="tabla_recetas" class="display">
    <thead>
    <tr>
        <th>ID</th>
        <th>Paciente</th>
    ...
    <tbody>
      ...
      if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td>" . $row["apellido_medico"] . "</td>";
            echo "<td>" . $row["fecha_hora"] . "</td>";
            echo "<td><a class='btn btn-primary' href='../reporte_receta.php?id_receta=" . $row["id_receta"] . "'><i class='fa-solid fa-print'></i> Imprimir Receta</a></td>";

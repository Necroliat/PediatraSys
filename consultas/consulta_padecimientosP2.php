...
$nombre_completo = $result_paciente->fetch_assoc()['nombre_completo'];

// Consulta para obtener los detalles de los padecimientos del paciente
$query_padecimientos = "SELECT 
                          dhc.IDdetalle_HC, 
                          p.nombre_padecimiento, 
                          dhc.notas, 
                          dhc.desde_cuando 
                        FROM 
                          detalle_historia_clinica dhc
                        JOIN 
                          historia_clinica hc ON dhc.ID_Hist_Clic = hc.ID_Hist_Clic
                        JOIN 
                          padecimientos_comunes p ON dhc.id_padecimiento = p.id_padecimiento
                        WHERE 
                          hc.ID_Paciente = $idpaciente";
...
<head>
  ...
  <title>Consulta/Reporte general de Padecimientos Comunes <?php echo $nombre_completo; ?></title>
...
<body>
  ...
  <h2 style="padding:0; text-align: center; text-transform: uppercase;">Padecimientos de:<?php echo $nombre_completo; ?></h2>

...
$query = "SELECT c.id_consulta,CONCAT(p.nombre, ' ', p.apellido) AS nombre_paciente,  
          CONCAT(m.nombre, ' ', m.apellido) AS nombre_medico, c.fecha, c.hora, c.diagnostico, c.tratamiento
          FROM consultas c
...
<body>
  ...
  <h2 style="padding:0; text-align: center; text-transform: uppercase;">Consultas en consultorio de Pacientes</h2>

  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#" onclick="cambiarIframe('menu2.php')" role="button">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      <!-- Brand Logo -->
      <a href="#" onclick="cambiarIframe('menu2.php')" class="brand-link">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="IMAGENES/businesswoman.bmp" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <iframe id="miIframe" width="100%" height="800px" frameborder="0" src="menu2.php"></iframe>

...
$query = "SELECT c.id_cita, c.fecha, c.hora, c.id_paciente, CONCAT(p.nombre, ' ', p.apellido) AS nombre_paciente, c.id_medico, CONCAT(m.nombre, ' ', m.apellido) AS nombre_medico
FROM citas c
...
<head>
  ...
  <title>Consulta Todos las Citas</title>
 ...
 <style>
    ...
    * {
    ...
    #tabla_especialidad tbody tr:hover {
      background-color: #A8A4DE;
      cursor: pointer;
    }

    #tabla_especialidad tbody tr:active {
...
<body>
  ...
  <table id="tabla_citas" class="display" style="width:100%">
    ...
    <tbody>
        <?php
        // Tu código PHP para obtener los datos de la consulta de citas aquí

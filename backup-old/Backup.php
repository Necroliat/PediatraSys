...
if ($result) {
    ...
    if ($error == 1) {
        ...
        if (fwrite($handle, $sql)) {
            fclose($handle);
            echo '<h3>Copia de seguridad realizada, en la carpeta> '.$ruta.'</h3>';
            echo '<div class="botones-container" style="margin-top:0%;">
            <a href="MainBackup.php" id="btnatras" class="btn btn-primary boton" style="width: 120px; font-size:small;vertical-align: baseline; font-weight:bold;">
              <i class="material-icons" style="font-size:small;color:#f0f0f0;text-shadow:2px 2px 4px #000000;">arrow_back</i> Atrás
            </a>
          </div>';
        } else {

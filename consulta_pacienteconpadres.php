...
// Consulta para obtener los datos de la tabla "paciente" solo si tienen un registro en "nino_padre"
...
// Consulta para obtener los datos de la tabla "paciente" solo si tienen un registro en "nino_padre"
$query = "SELECT DISTINCT p.id_paciente, p.nombre, p.apellido, p.sexo, p.fecha_nacimiento, p.Nacionalidad, p.Con_quien_vive, p.Direccion_reside
          FROM paciente p
          JOIN nino_padre np ON p.id_paciente = np.id_paciente";

...
if (isset($_GET['id_medico'])) {
    ...
    header("Location: consultacitasmedico2.php");
...
<body>
    <fieldset>
    <div class="centrado">
            <img src="IMAGENES/LOGO/LOGO.png" class="" alt="Mantenimientos" style="width: 100px; height: 100px;"><img src="IMAGENES/citamedica-64.png" class="" alt="Mantenimientos" style="width: 64px; height: 64px;">
        </div>

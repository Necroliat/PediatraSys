...
if($totalErrors<=0){
	echo '<p>Restauración completada con éxito. Se ejecutaron ' . $totalQueries . ' consultas.</p><a href="index.php" id="btnatras" class="btn btn-primary boton" style="width: 120px; font-size:small;vertical-align: baseline; font-weight:bold;"><i class="material-icons" style="font-size:small;color:#f0f0f0;text-shadow:2px 2px 4px #000000;">reply</i> atrás</a>';

...
define("USER", "Admin_pediatra");

//Servidor de mysql
define("SERVER", "localhost");

//Nombre de la base de datos
define("BD", "pediatra_sis");

//Contraseña de myqsl
define("PASS", "Hola@1024");
...
class SGBD{
    ...
    public static function sql($query) {
        ...
        if ($mysqli->connect_error) {
            ...
            // Configurar el conjunto de caracteres y transacciones
            $mysqli->set_charset('utf8');
            $mysqli->autocommit(false);
    
            // Iniciar la transacción
            if (!$mysqli->begin_transaction()) {
                echo "Error al iniciar la transacción";
            } else {

    ...
    <div class="container">
        <fieldset style=" padding-bottom:40%">
            ...
            <form name="miFormulario" class="contenedor_popup" method="POST" onsubmit="return validarFormulario()">
                <fieldset class="caja">
                    <legend class="cajalegend">══ Tipo de Análisis ══</legend>
                    <!-- <div>
                        <label>ID del Análisis</label>
                        <input type="text" autofocus name="id_analisis" id="id_analisis" autocomplete="off" required>
                    </div> -->
                    <br>
                    <div>
                        <label>Nombre</label>
                    ...
                    <div>
                        ...
                        <textarea name="descripcion" id="descripcion" autocomplete="off" required></textarea>
                    </div>
                    <br>
...
if (isset($_POST['btnagregar'])) {
    ...
    // Consulta SQL para insertar datos en la tabla tipos_analisis
    $sql = "INSERT INTO tipos_analisis (Nombre, descripcion) VALUES ('$nombre', '$descripcion')";

    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Datos guardados exitosamente.'); window.location.href='../../mant-tipos_analisis.php';</script>";
    } else {
        echo "<script>alert('Error al guardar los datos: " . $conn->error . "'); window.location.href='../../mant-tipos_analisis.php';</script>";
    }
}
?>
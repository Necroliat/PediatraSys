...
paciente p
WHERE 
p.id_paciente NOT IN (SELECT sp.id_paciente FROM seguro_paciente sp);
";
...
<!-- <div class="centrado">
        ...
        <h4 style="padding:0; text-align: center; text-transform: uppercase;">Consulta de Pacientes Sin Seguro Medico</h4>
